...
return [
    ...
    */
    ...
    'connections' => [
        ...
        // Runtime-selected company database. TenantConnectionManager fills
        // the database/host credentials from the central tenants registry
        // before any CRM model is queried.
        'tenant' => [
            'driver' => 'mysql',
            'url' => null,
            'host' => env('DB_HOST', '127.0.0.1'),
