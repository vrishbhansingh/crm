...
<style>.audit-card{border:0;border-radius:14px;box-shadow:0 7px 25px rgba(30,64,175,.08)}.audit-event{font-size:11px;font-weight:700;text-transform:uppercase}.change-json{white-space:pre-wrap;word-break:break-word;font-size:11px;max-height:180px;overflow:auto;background:#f8fafc;padding:9px;border-radius:7px}.filter-grid{display:grid;grid-template-columns:repeat(auto-fit,minmax(145px,1fr));gap:10px}</style></head>
