...
@php
  ...
  $crumbMap = [
    ...
    'quotations.index' => ['Delivery & Billing', 'Quotations'],
    'quotations.create_form' => ['Delivery & Billing', 'Quotations', 'New Quotation'],
    'quotations.show' => ['Delivery & Billing', 'Quotations', 'Quotation Details'],
    'products.index' => ['Delivery & Billing', 'Products'],
