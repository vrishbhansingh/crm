...
<body>
    ...
    <script>
        ...
        function getLeadList() {
            const viewLeadUrlTemplate = "{{ route('user.view_lead_list', ':id') }}";
            $.ajax({
                url: '{{ route("user.get_lead_list") }}',
                type: 'GET',
                  ...
                  `);
                    ...
                    <tr>
                      ...
                      <td class="text-center">
                        ...
                        <td class="text-center">${formatLeadStatus(lead.lead_source) ?? '-'}</td>
                        <td class="text-center">
        ...
        function getStatusBadge(status) {
            switch (status) {
                ...
                case 'contacted':
                    return '<span class="badge badge-info">Contacted</span>';
                case 'follow_up':
                    return '<span class="badge badge-warning">Follow Up</span>';
                case 'not_interested':
        ...
        $(document).on('click', '#refreshLeads', function() {
            setTimeout(() => {
                location.reload();
            }, 500);
        });
