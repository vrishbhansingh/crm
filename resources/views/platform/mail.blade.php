...
<style>
    ...
    .section-divider {
        border-top: 1px solid var(--border); margin: 22px 0 18px; padding-top: 18px;
    }
</style>

<p class="mail-intro">
    This is the fallback SMTP used to send <strong>every Super Admin email</strong> (like your own password resets)
    and any company that hasn't set up its own mail server yet. Pick your provider below to auto-fill the
    correct settings — you'll only need to enter your login details.
</p>
...
<div class="section-divider">
    <h5 class="mb-1">Send a test email</h5>
    <p class="text-muted small">Save your settings above first, then send a test to confirm they actually work — don't just assume. The result (sent, or the exact error) shows at the top of this page after you submit.</p>
